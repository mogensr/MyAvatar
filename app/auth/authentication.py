"""
Authentication functions for MyAvatar - Enhanced Version
"""
...
# Password handling with stronger configuration
...
def authenticate_user(username: str, password: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        try:
            ...
            log_error(f"Failed to update last login for user {username}", "Auth", e)
...
def authenticate_user_by_email(email: str, password: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        try:
            ...
            log_error(f"Failed to update last login for email {email}", "Auth", e)
