# app/routes/backgroundfx_iframe.py - IFRAME INTEGRATION FOR MYAVATAR
import logging
import os
...
async def backgroundfx_page(request: Request, username: str = Depends(get_current_user)):
...
async def admin_backgroundfx_info(username: str = Depends(get_current_user)):
